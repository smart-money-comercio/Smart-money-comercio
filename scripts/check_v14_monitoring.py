...
REQUIRED_REPORT_BUILDERS = [
    ("src.reports.allocation_report", "build_allocation_report"),
        ...
        ("src.reports.agentlog_report", "build_agentlog_report"),
        ("src.reports.watchdog_report", "build_watchdog_report"),
        ("src.reports.sourcehealth_report", "build_sourcehealth_report"),
        ("src.reports.source_refresh_report", "build_source_refresh_status_report"),
        ("src.reports.commandcenter_report", "build_commandcenter_report"),
    ...
    ("src.reports.tradeplans_report", "build_tradeplans_report"),
    ("src.reports.tradeplan_report", "build_tradeplan_report"),
